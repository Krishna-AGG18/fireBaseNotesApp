    ...
    return (
        <div className='w-full min-h-dvh relative text-white bg-black'>
            ...
            <div className='absolute top-0 w-full py-8 flex flex-col gap-8 px-4 sm:px-6 md:px-10'>
                {/* Navbar */}
                <nav>
                    <div className='flex justify-between items-center gap-4 sm:gap-0 px-6 sm:px-10 py-4 rounded-full bg-white/20 backdrop-blur-md border-gray-400 border-[0.5px] max-w-[95%] sm:max-w-[80%] lg:max-w-[70%] mx-auto'>
